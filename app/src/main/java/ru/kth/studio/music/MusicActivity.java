...
public class MusicActivity extends AppCompatActivity {
	...
	private String str, namestr, infostr, notifname, text, lyrics, str1, image, str2;
	public static String song_name, artist, album, img, currentfile;
	...
	private ImageView imageview6, imageview1, imageview2, imageview3, imageview5;
	private ListView listview3;
	private RecyclerView recyclerview1;
	private SeekBar seekbar1;
	public static MediaPlayer raone;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		mediaSessionConnector.setPlayer(raone);
		initialize();
		initializeLogic();
	}
				...
				t = new TimerTask() {
					...
					public void run() {
						runOnUiThread(() -> {
							...
							textview5.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
						});
					}
				};
	...
	private class BackTask extends AsyncTask < String, Integer, String > {
		...
		protected void onPostExecute(String s) {
			...
			if (raone != null && raone.isPlaying()) { raone.stop();}
			_me();
		}
	}
		...
		t = new TimerTask() {
			...
			public void run() {
				runOnUiThread(() -> {
						textview3.setText(new DecimalFormat("00").format((raone.getCurrentPosition() / 1000) / 60).concat(":".concat(new DecimalFormat("00").format((raone.getCurrentPosition() / 1000) % 60))));
						textview4.setText("-".concat(new DecimalFormat("00").format(((raone.getDuration() - raone.getCurrentPosition()) / 1000) / 60).concat(":".concat(new DecimalFormat("00").format(((raone.getDuration() - raone.getCurrentPosition()) / 1000) % 60)))));
						textview4.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
						textview3.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
	...
	public void _bottom() {
		...
		album.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		artist.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		artist_text.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		album_text.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		lyrics_text.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		info_text.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
	...
	public void _lyrics() {
		...
		text.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		...
		about.setText(ssb);
		about.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
		bs_base.show();
	}
    ...
    public void sendOnChannel2(View v) {
		...
		song_name = notifname;
		artist = map.get(0).get("artist").toString();
		album = map.get(0).get("album").toString();
		getBitmapFromURL(image);
		img = image;
		dur = raone.getDuration();
		ContextCompat.startForegroundService(MusicActivity.this.getApplicationContext(), new Intent(MusicActivity.this.getApplicationContext(), MediaSessionService.class));
    }
	...
	public void _me() {
		...
		textview2.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.NORMAL);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			if (play.get(_position).containsKey("written")) {
				...
				textview1.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/raleway.ttf"), Typeface.BOLD);
			} else {
